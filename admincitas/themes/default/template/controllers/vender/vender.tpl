                                   ...
                                   <div class="mb-4 collapse show">
                                        <div class="card">
                                            <div class="card-body">
                                                ...
                                                <div>
                                                    <div class="row mb-4" v-if="!hasComprobante && cart.length">
                                                            ...
                                                            <div class="my-3 sales-add-edit-payments" v-for="(pago, ind) in pagos" :key="'ind-' + ind">
                                                                <div class="input-group">
                                                                    <select  id="inputPaymentMethod" class="custom-select form-control" v-model.number="pago.id_metodo_pago" @change="changeMetodoPago($event, pago)">
                                                                        <option data-tipo="efectivo" value="0">Pago con Efectivo</option>
                                                                        <option data-tipo="visa" value="1">Pago con Visa</option>
                                                                        <option data-tipo="izipay" value="2">Pago con Izipay</option>
                                                                    </select>

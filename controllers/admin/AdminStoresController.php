...
//        return parent::renderList();
    ...
    protected function _getDefaultFieldsContent()
    {
        ...
        $formFields = array(
            ...
            'PS_SHOP_RAZON_SOCIAL' => array(
                'title' => $this->trans('RAZON SOCIAL', array(), 'Admin.Shopparameters.Feature'),
                'hint' => $this->trans('Coloque la razón social tan cual esta en SUNAT.', array(), 'Admin.Shopparameters.Feature'),
                'validation' => 'isGenericName',
                'required' => true,
                'type' => 'text',
                'no_escape' => true,
            ...
            'PS_SHOP_RUC' => array(
                'title' => $this->trans('RUC', array(), 'Admin.Shopparameters.Feature'),
                'hint' => $this->trans('El RUC de su empresa.', array(), 'Admin.Shopparameters.Feature'),
                'validation' => 'isGenericName',
                'required' => true,
                'type' => 'text',
                'no_escape' => true,

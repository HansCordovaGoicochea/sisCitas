 ...
 * @since 1.5
 */
class HTMLTemplateComprobanteFisicoNotaCreditoCore extends HTMLTemplate
{
    public $comprobante;
    public $order;
...
//    d($this->smarty->fetch($this->getTemplateByCountry($country->iso_code)));
    ...
    {
        $var_documento = 'ComprobanteFisicoNotaCredito';
//                $file = Configuration::get('PS_INVOICE_MODEL');
    ...
    {
        return 'ComprobanteFisicoNotaCredito.pdf';
    }

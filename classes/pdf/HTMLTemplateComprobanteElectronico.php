 ...
 * @since 1.5
 */
class HTMLTemplateComprobanteElectronicoCore extends HTMLTemplate
{
    public $comprobante;
    public $order;
...
//        d($logo);
        $con = Contact::getCategoriesContacts();
...
//        d($objC);
    ...
    {
        $var_documento = 'ComprobanteElectronico';
//                $file = Configuration::get('PS_INVOICE_MODEL');
    ...
    {
        return 'ComprobanteElectronico.pdf';
    }

...
class __TwigTemplate_5ae965baac45147ef261154aad753d4e49d7a67eff64fccf8ceb5e91ca1096b4 extends Twig_Template
{
  ...
  ";
        // line 26
        if (($this->getAttribute($this->getAttribute($this->getAttribute((isset($context["app"]) ? $context["app"] : null), "request", array()), "attributes", array()), "get", array(0 => "_route"), "method") == "admin_module_catalog_refresh")) {
            // line 27
            echo "    ";
...
";
    ...
    public function block_addon_card($context, array $blocks = array())
    {
        // line 33
        echo "      ";
        $this->loadTemplate("PrestaShopBundle:Admin/Module/Includes:card_list.html.twig", "PrestaShopBundle:Admin/Module/Includes:grid.html.twig", 33)->display(array_merge($context, array("module" => (isset($context["module"]) ? $context["module"] : null), "origin" => ((array_key_exists("origin", $context)) ? (_twig_default_filter((isset($context["origin"]) ? $context["origin"] : null), "none")) : ("none")))));
        // line 34
        echo "    ";
    }
    ...
    public function block_addon_search_card($context, array $blocks = array())
    {
        // line 37
        echo "    ";
        if ((array_key_exists("requireAddonsSearch", $context) && ((isset($context["requireAddonsSearch"]) ? $context["requireAddonsSearch"] : null) == true))) {
            // line 38
            echo "      ";
    ...
    {
        return new Twig_Source("", "PrestaShopBundle:Admin/Module/Includes:grid.html.twig", "C:\\xampp\\htdocs\\siscitas\\src\\PrestaShopBundle/Resources/views/Admin/Module/Includes/grid.html.twig");
    }
}
